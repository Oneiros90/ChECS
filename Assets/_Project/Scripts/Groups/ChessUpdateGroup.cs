...
namespace CHECS
{
    ...
    public partial class ChessUpdateSystemGroup : ComponentSystemGroup { }

    [UpdateInGroup(typeof(ChessUpdateSystemGroup), OrderFirst = true)]
    public unsafe partial class BeginChessUpdateEntityCommandBufferSystem : EntityCommandBufferSystem
    {
        /// <summary>
    ...
    [UpdateInGroup(typeof(ChessUpdateSystemGroup), OrderLast = true)]
    public unsafe partial class EndChessUpdateEntityCommandBufferSystem : EntityCommandBufferSystem
    {
        /// <summary>
        /// Call <see cref="SystemAPI.GetSingletonRW{T}"/> to get this component for this system, and then call
        /// <see cref="CreateCommandBuffer"/> on this singleton to create an ECB to be played back by this system.
