...
namespace CHECS
{
    ...
    public partial class InputUpdateSystemGroup : ComponentSystemGroup { }

    [UpdateInGroup(typeof(InputUpdateSystemGroup), OrderFirst = true)]
    public unsafe partial class BeginInputUpdateEntityCommandBufferSystem : EntityCommandBufferSystem
    {
        /// <summary>
    ...
    [UpdateInGroup(typeof(InputUpdateSystemGroup), OrderLast = true)]
    public unsafe partial class EndInputUpdateEntityCommandBufferSystem : EntityCommandBufferSystem
    {
        /// <summary>
        /// Call <see cref="SystemAPI.GetSingletonRW{T}"/> to get this component for this system, and then call
        /// <see cref="CreateCommandBuffer"/> on this singleton to create an ECB to be played back by this system.
