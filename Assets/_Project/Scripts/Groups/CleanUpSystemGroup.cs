...
namespace CHECS
{
    ...
    {
        [Preserve]
        public CleanUpSystemGroup() { }
    }

    [UpdateInGroup(typeof(CleanUpSystemGroup), OrderFirst = true)]
    public unsafe partial class BeginCleanUpEntityCommandBufferSystem : EntityCommandBufferSystem
    {
        /// <summary>
    ...
    public unsafe partial class EndCleanUpEntityCommandBufferSystem : EntityCommandBufferSystem
    {
        /// <summary>
        /// Call <see cref="SystemAPI.GetSingletonRW{T}"/> to get this component for this system, and then call
        /// <see cref="CreateCommandBuffer"/> on this singleton to create an ECB to be played back by this system.
